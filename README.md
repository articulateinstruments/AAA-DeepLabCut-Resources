...
In _AAA_ you can either use DeepLabCut to spline existing recordings or use it to track anatomy live in real-time. For live tracking, a computer with a CUDA GPU (as of the year 2022) can process data fast enough to do real-time tracking at 15-20 Hz, and if you don't have a CUDA GPU then a common office PC in 2022 can do 4-10 Hz.
> _The slower framerate on a common office PC is not high enough to be adequate for live-tracking fast tongue movements such as trills, but it may still be valuable for providing visual feedback for slower tongue movements, depending on your needs_.
